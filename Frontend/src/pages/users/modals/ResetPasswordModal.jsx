...
export function ResetPasswordModal({ open, onClose, user, onDone }) {
  ...
  return (
    ...
    >
      <form onSubmit={submit} className="space-y-2 px-5 py-5">
        ...
        <p className="pt-1 text-xs text-muted-foreground">Share the new password with the user securely. They can change it from their profile.</p>
      </form>
    </Modal>
  );
}
